...
def getWordScore(word, n):
    ...
    for char in word:
        if char in SCRABBLE_LETTER_VALUES:
            initialvalue += SCRABBLE_LETTER_VALUES[char]
            availablechar.append(SCRABBLE_LETTER_VALUES[char])
            sumupvalue = initialvalue
            totalscore = len(availablechar)*sumupvalue
        if n == len(availablechar):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:      
        ...
        # Otherwise (the input is not a single period):
            ...
            if not isValidWord(usersword, hand, wordList):
            ...
            # Reject invalid word (print a message followed by a blank line)
                ...
                # Update the hand 
                updateHand(hand, usersword)
                newscore += getWordScore(usersword, n)
                hand = updateHand(hand, usersword)
                print('"', usersword, '" earned ',  getWordScore(usersword, n), ' points. Total: ', newscore, ' points.')
                print()
...
#        print('You have not played a hand yet. Please play a new hand first!')
#        print ()
#        whattoplay = input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
#    while not whattoplay == 'e':
#        playedtime = 0
#
#        if whattoplay == 'n':
...
#            playedtime = 1
#        if whattoplay == 'r':
#            playHand(prevHand.copy(), wordList, HAND_SIZE)
#
#        if playedtime == 0:
#            print('Invalid command.')
#        whattoplay = input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
